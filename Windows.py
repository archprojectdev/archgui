...
class Windows:
    ...
    def open(self, model: str, monitor: str, id: str, title: str, uniqid=None, location=None, size=None):
        """
    ...
    def update(self, uniqid: str, items: list) -> bool:
        """
    ...
    def graph_draw_image(self, uniqid: str, graph: str, location: list, image=None) -> bool:
        """
    ...
    def graph_bring_figure_to_front(self, uniqid: str, graph: str, figure: int) -> bool:
        """
    ...
    def graph_send_figure_to_back(self, uniqid: str, graph: str, figure: int) -> bool:
        """
